...
% EAGLE è almeno espressivo quanto LTLP
...
%%  esempio sbagliato IMO
%\begin{align*}
%    & \underline{\text{min}}\ \mathtt{SafeUse}(\underline{\text{string}}\ c,\underline{\text{int}}\ i) = ((name=c)\rightarrow(ip=i))\land\odot\ \mathtt{SafeUse}(c,i) \\
%    & \underline{\text{mon}}\ \mathtt{CookieSafe} =\ \mathtt{Always}(\mathtt{SafeUse}(name,ip)) 
%\end{align*}
\begin{align*}
