...
\begin{frame}[allowframebreaks]{Evaluation algorithm}
    ...
    \begin{ex}
        ...
        \vspace{2.5mm}
        and a trace $\sigma=\alpha_1,\alpha_2$, where $\alpha_1=\{userId:\mathtt{"Lori"},\ action:\mathtt{login},\ time:\mathtt{17.0}\}$ and $\alpha_2=\{userId:\mathtt{"Lori"},\ action:\mathtt{logout},\ time:\mathtt{150.0}\}$.\\ $M_3$ gets modified, at first step, in \\
        \vspace{2.5mm}
